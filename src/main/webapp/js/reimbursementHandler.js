...
const newReimbursementModalOpenHandler = () => {
  document.getElementById('new-reimbursement-modal').setAttribute('class', 'modal active');
  document.getElementById('modal-backdrop').setAttribute('class', 'active');
  document.getElementById('modal-backdrop').addEventListener('click', newReimbursementModalCloseHandler);
  generateForm();
}

const newReimbursementModalCloseHandler = () => {
  document.getElementById('new-reimbursement-modal').setAttribute('class', 'modal');
